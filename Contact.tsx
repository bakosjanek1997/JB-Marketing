...
const Contact: React.FC<ContactProps> = ({ t }) => {
  ...
  const handleBooking = () => {
    if (selectedDay && selectedTime) {
      const message = t.alertSuccess
        .replace('{day}', selectedDay.toString())
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div id="booking-calendar" className="scroll-mt-32 bg-white dark:bg-slate-900 rounded-2xl shadow-2xl p-6 border border-slate-200 dark:border-slate-800 transform transition-transform duration-500 hover:scale-[1.01]">
            <div className="flex items-center justify-between mb-6 border-b border-slate-100 dark:border-slate-800 pb-4">
                <div className="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-slate-500">30 min Strategy Call</p>
                    </div>
                </div>
            </div>
            ...
            <div className="space-y-4">
                ...
                <h5 className="font-semibold text-slate-900 dark:text-white mt-6 mb-3">Available times</h5>
